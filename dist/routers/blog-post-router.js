...
const queryParamsMiddleweare_1 = require("../middleweares/queryParamsMiddleweare");
...
exports.blogPostRouter.get('/:id/posts', queryParamsMiddleweare_1.blogPostsUriParamsId, blog_post_controller_1.blogPostsController.getAllPostsForBlog);
